...
- AI（私）が外部に投稿するコメント（PR レビュー，issue コメント等）は，AI 発信だと分かるように `🤖` 絵文字を添えるなどして明示する．人手のレビュー・コメントと区別できるようにするため．（これは AI 発信を示す意図的なマーカーであり，上の「装飾記号を使わない」＝列挙・参照番号の装飾禁止 とは別物）
